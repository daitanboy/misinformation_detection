...
# Load the cleaned dataset (df_combined) for error analysis
df_combined = pd.read_csv('cleaned_data.csv')  # Load the cleaned dataset
...
original_texts = df_combined.iloc[y_test.index[misclassified_indices]]  # Now df_combined is defined
